...
intrinsic PFrobeniusAction(a::RngIntElt, hbar::RngUPolElt, N::RngIntElt)\
-> AlgMatElt
{
...
-> AlgMatElt
{
    ...
    error if not IsSeparable(hbar), "The current implementation only\
                                     supports squarefree hbar.";
    error if not (Gcd(a,b) eq 1), "The current implementation needs a and\
                                   the degree of hbar to be coprime.";
